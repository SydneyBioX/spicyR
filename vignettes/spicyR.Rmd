...
# Overview
This guide will provide a step-by-step guide on how to use the `spicyR` package to 
identify how the localisation of different cell types can change across different conditions. 


# Example data

To illustrate the functionality of `spicyR` we will use a study on triple negative breast cancer containing 40 samples measured using MIBI-TOF published by [Keren et al. (2018)](https://doi.org/10.1016/j.cell.2018.08.039).

We can download a `SpatialExperiment` which contains the spatial coordinates of every cell within each in the dataset as well as a corresponding cell type label.
