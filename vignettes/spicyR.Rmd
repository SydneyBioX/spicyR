...
`spicyR` provides a convenient function for converting the `colPairs` object
into an abundance dataframe, effectively calculating the average number of nearby cells
types for every cell type. 
